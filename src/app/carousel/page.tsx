      ...
      {(status === "idle" || status === "failed") && creatorInfo && (
        <div className="space-y-6">
          ...
          <div>
            ...
            <p className="text-xs text-neutral-500 mb-3">
              Turn on to disclose that this carousel promotes goods or services in
              exchange for something of value. Your carousel could promote
              ...
              <div className="ml-7 space-y-3 border-l-2 border-neutral-200 dark:border-neutral-700 pl-4">
                ...
                {isPromotionalContent && (
                  <div className="p-3 bg-neutral-50 dark:bg-neutral-800 rounded-lg space-y-1">
                    ...
                    <p className="text-xs text-neutral-500">
                      This cannot be changed once your carousel is posted.
                    </p>
                  </div>
                )}
